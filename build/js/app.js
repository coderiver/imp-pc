...
$(function() {
    ...
    (function() {
        $('.tile__check-all input[type="checkbox"]').each(function(i, el) {
            var allCheck = $(el);
            var checkboxes = allCheck.parents('.tile').find('.check-list').find('input[type="checkbox"]');

            checkboxes.on('change', function() {
                allCheck[0].checked = !checkboxes.not(':checked').length;
            });
    ...
    (function() {
        ...
        var radio = container.find('.tile .radio');
    ...
    $('.check-group').on('click', function(e) {
        $(this).find('.check, .radio').trigger('click');
    });
